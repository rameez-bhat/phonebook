    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('adminPostEditCustomerContact',['id'=>$data[0]['id'],'clientid'=>$UserSelected]) }}">
                        @csrf
                        @if($errors->any())
...
@endif
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              ...
                              @foreach ($ClientList->all() as $Client)
                              <option value="{{$Client->id}}" {{ ( $Client->id == $UserSelected ) ? 'Selected' : '' }}>{{$Client->name}}</option> 
                              @endforeach
                              </select>
                                @error('user_id')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{$data[0]['phone']}}" required autocomplete="phone">
