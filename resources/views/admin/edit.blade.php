    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('postAdminUpdateCustomer', ['id' => $data[0]['id']] ) }}">
                        @csrf
                        @if($errors->any())
...
@endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              ...
                              <option value="user" {{($data[0]['type'] === 'user') ? 'Selected' : ''}}>Client</option>  
                              <option value="admin" {{($data[0]['type'] === 'admin') ? 'Selected' : ''}}>Admin</option>
